...
red1_low = np.array([0, 70, 50])
red1_up = np.array([10, 255, 255])
red2_low = np.array([170, 70, 50])
...
if contours:
    ...
    if M["m00"] != 0:
        ...
        cv2.putText(image, "Red Ball", (cx + 10, cy), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 2)

cv2.imshow("Red Ball Tracking", image)
cv2.waitKey(0)
